 ...
 * @author cunpl
 */
@WebServlet(name = "DenailRequestAdminServlet", urlPatterns = {"/DenailRequestAdminServlet"})
public class DenailRequestAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (RQDao.denailRequestStatusAdmin(Integer.parseInt(requestId))) {
                msg = "Denail Success!";
