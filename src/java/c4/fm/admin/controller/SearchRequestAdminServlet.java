 ...
 * @author cunpl
 */
@WebServlet(name = "SearchRequestAdminServlet", urlPatterns = {"/SearchRequestAdminServlet"})
public class SearchRequestAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<RequestMentorDTO> listRQ = null;
            listRQ = RQDao.searchListRequestMentorAdmin(searchValue);
