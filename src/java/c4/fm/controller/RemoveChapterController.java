 ...
 * @author hoang
 */
@WebServlet(name = "RemoveChapterController", urlPatterns = {"/RemoveChapterController"})
public class RemoveChapterController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.RemoveNewChapter(chapterID);
            if (check) {
                url = SUCCESS;
            }
        } catch (Exception e) {
